...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--restore-from", type=str, default='../path/to/snapshots/eyes_ssl_24/eyes_27000', help="Where restore model parameters from.")
        #parser.add_argument("--restore-from", type=str, default='../path/to/snapshots/level_0.2-0.3/eyes_noise_only_0.1/eyes_7000', help="Where restore model parameters from.")
        ...
        parser.add_argument("--snapshot-dir", type=str, default='../path/to/snapshots/level_0.5-0.7/eyes_weight_0.1', help="Where to save snapshots of the model.")

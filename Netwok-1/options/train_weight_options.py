...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--data-dir", type=str, default='/extracephonline/medai_data2/zhengdzhang/eyes/qikan/correction/new-dataset', help="Path to the directory containing the source dataset.")
        ...
        parser.add_argument("--data-label-folder-target", type=str, default='/extracephonline/medai_data2/lolitazhang/my-master/eyes-master/data/refuge-new/target/pseudo_label_folder_name', help="Path to the soft assignments in the target dataset.")
        ...
        parser.add_argument("--restore-from", type=str, default='/extracephonline/medai_data2/lolitazhang/my-master/eyes-master/path/to/snapshots/eyes_ssl_24/eyes_27000', help="Where restore model parameters from.")
        parser.add_argument("--print-freq", type=int, default=1, help="print loss and time fequency.")
        parser.add_argument("--snapshot-dir", type=str, default='../path/to/snapshots/level_0.2-0.3/eyes_weight_0.1', help="Where to save snapshots of the model.")
        ...
        parser.add_argument('--save_selected_samples', type=str, default='/extracephonline/medai_data2/zhengdzhang/eyes/qikan/correction/n1/clean_list/level_0.5-0.7/noise_labels_0.5/sample_selected_0.3_new.txt')
        parser.add_argument('--noise_selected_samples', type=str, default='/extracephonline/medai_data2/zhengdzhang/eyes/qikan/correction/n1/noise_list/level_0.5-0.7/noise_labels_0.5/noise_selected_0.3_new.txt')

...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument('--save_selected_samples', type=str, default='../clean/n1/clean_list/level_0.2-0.3/noise_labels_0.1/clean_selected_0.1.txt')
        parser.add_argument('--noise_selected_samples', type=str, default='../noisy/n1/noise_list/level_0.2-0.3/noise_labels_0.1/noise_selected_0.1.txt')

...
def calculate_dice(mask_path, prediction_path):
    ...
    for filename in file_test_list:
        mask = np.asarray(image.load_img(os.path.join(mask_path, filename), grayscale=True)) # mask [512,512] (0,128,255)
...
if __name__ == '__main__':
    ...
    data_img_path = '../data/' + dataset + '/'+ phase +'/disc_small/image/'
    data_save_path = '../data/' + dataset + '/' + phase + '/0.5-0.7_noise_0.5/'
    mask_path = '../data/' + dataset + '/'+ phase +'/disc_small/mask/'

    # change location to wherever you like
    # load_from = "../weights/" + dataset + "/DA_patch/Generator/generator_100.h5"
    #load_from = "../weights/Drishti-GS/DGS_0.2-0.3/DA_noise_0.5/Generator/generator_1000.h5"
    load_from = "../weights/refuge-new/level_0.5-0.7/DA_noise_none_0.5/Generator/generator_2000.h5"
    ...
    disc_dice, cup_dice = calculate_dice(mask_path, data_save_path)

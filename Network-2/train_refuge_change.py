...
parser.add_argument('--data-list-source', type=str, default='../path/to/dataset-new/source.txt', help="Path to the file listing the images in the source dataset.")
parser.add_argument('--data-list-target', type=str, default='../path/to/dataset-new/target.txt', help="Path to the file listing the images in the source dataset.")
#parser.add_argument('--load_selected_samples', type = str, help = 'dir to load selected samples', default = '../path/to/dataset-new/source/eyesgan/level_0.5-0.7/noise_labels_0.1/sample_dice1.txt')
...
parser.add_argument('--restore-from', type=str, default='../weights/refuge-new/level_0.5-0.7/DA_noise_weight_0.1/Generator/generator_1000.h5')
parser.add_argument('--weight-root', type=str, default='../weights/refuge-new/level_0.5-0.7/DA_weight_0.1')
...
if __name__ == '__main__':
    ...
    #weights_path = "weights/" + dataset_t + "/DA_patch2/_{epoch:04d}.hdf5"
    #load_from = "./weights/weights1.h5"
    #load_from = "./weights/Drishti-GS-new/DA_patch/Generator/generator_100.h5"
    #load_from = "./weights/refuge-new/DA_patch/Generator/generator_100.h5"
    #load_from = "../weights/refuge-new/level_0.5-0.7/DA_noise_weight_0.1/Generator/generator_1000.h5"
    ...
    trainGenerator_Gene = Generator_Gene(args.data_list_source, batch_size, '../data/'+dataset_t+'/source/disc_small', DiscROI_size,
                                         CDRSeg_size = CDRSeg_size, pt=False, phase='train')

    valGenerator_Gene = Generator_Gene(args.data_list_target, batch_size, '../data/' + dataset_t + '/target/disc_small', DiscROI_size,
                                       CDRSeg_size=CDRSeg_size, pt=False, phase='val')

    trainAdversarial_Gene = Adversarial_Gene(batch_size, '../data/' + dataset_t + '/source/disc_small', DiscROI_size,
                                             CDRSeg_size=CDRSeg_size, phase='train', noise_label=False)
    trainDS_Gene = GD_Gene(batch_size, '../data/' + dataset_t + '/source/disc_small', True,
                           CDRSeg_size=CDRSeg_size, phase='train', noise_label=False)
    trainDT_Gene = GD_Gene(batch_size, '../data/' + dataset_t + '/target/disc_small', False,
                           CDRSeg_size=CDRSeg_size, phase='train', noise_label=False)
